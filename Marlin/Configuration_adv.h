 ...
 */
  ...
  #define THERMAL_PROTECTION_COOLER_PERIOD    180 // Seconds
  #define THERMAL_PROTECTION_COOLER_HYSTERESIS  6 // Degrees Celsius

  /**
   * Laser cooling watch settings (M143/M193).
   */
  #define WATCH_COOLER_TEMP_PERIOD            180 // Seconds
  #define WATCH_COOLER_TEMP_INCREASE            1 // Degrees Celsius
#endif
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { { 230, 150 }, { 70,  150 } }
  /**
  ...
  //#define Z_STEPPER_ALIGN_STEPPER_XY { { 210.7, 102.5 }, { 152.6, 220.0 }, { 94.5, 102.5 } }
    ...
    #define Z_STEPPER_ALIGN_AMP 2.0       // Use a value > 1.0 NOTE: This may cause instability!
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH           40  // (mm) Initial retract.
  ...
  #define FILAMENT_UNLOAD_PURGE_LENGTH        80  // (mm) An unretract is done, then this length is purged.
